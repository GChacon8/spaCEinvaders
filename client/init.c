...
{
	glob_t paths = { 0 };
	if(glob("/home/emanuel/CLionProjects/DonCEy-Kong-Jr/assets/sprites/*/\?\?-*.png", GLOB_FLAGS, NULL, &paths) != 0)
	{
...
void init_sdl(void)
{
	...
	{
		sdl_image_fatal();
	} else if(TTF_Init() != 0 || !(game.font = TTF_OpenFont("/home/emanuel/CLionProjects/DonCEy-Kong-Jr/assets/arcade_n.ttf", FONT_POINT_SIZE)))
	{
		sdl_ttf_fatal();
	}
}