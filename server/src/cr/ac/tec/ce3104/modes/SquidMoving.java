...
public class SquidMoving implements Mode{
    ...
    public SquidMoving(Integer speedDenominator, Boolean isList) {
    ...
    public Speed getSpeed() {
        SpeedRatio ratio;
        if(isList){
            ratio = new SpeedRatio(SquidMoving.SPEED_NUMERATOR_LIST, this.speedDenominator);
        }
        else{
            ratio = new SpeedRatio(SquidMoving.SPEED_NUMERATOR, this.speedDenominator);
        }
